...
const ChatroomSelectRoom = ({
  ...
  return (
    <div
      ref={dropdownRef}
      className="relative inline-block rounded border border-transparent px-2 text-left transition-shadow hover:border-bitrush-blue-700 hover:shadow-glow-blue-hovered"
    >
      <div
